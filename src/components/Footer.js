          ...
          <div>
            ...
            <ul className="footer-contact">
              <li>
                ...
                <div>
                  <p>Village &amp; Post Office Gulalta, Tehsil Punhana, District Nuh, Haryana 122508, India</p>
                </div>
              </li>
              <li>
                <span className="icon">
                ...
                <div>
                  <p><a href="tel:+919813893744" style={{ color: 'inherit' }}>+91 98138 93744</a></p>
                  <p><a href="tel:+919812893744" style={{ color: 'inherit' }}>+91 98128 93744</a></p>
                </div>
              </li>
              <li>
                <span className="icon">
                ...
                <div>
                  <p><a href="mailto:wafatrustindia@gmail.com" style={{ color: 'inherit' }}>wafatrustindia@gmail.com</a></p>
                </div>
              </li>
            </ul>
          </div>
