...
export default function sitemap() {
  ...
  const staticPaths = [
    ...
    { p: '/chairman-message', priority: 0.5, freq: 'yearly' },
    { p: '/mission', priority: 0.6, freq: 'monthly' },
    { p: '/vision', priority: 0.6, freq: 'monthly' },
    { p: '/gallery', priority: 0.6, freq: 'monthly' },
    { p: '/videos', priority: 0.5, freq: 'monthly' },
    { p: '/education', priority: 0.7, freq: 'monthly' },
    { p: '/wafa-board', priority: 0.5, freq: 'monthly' },
    { p: '/events', priority: 0.5, freq: 'monthly' },
